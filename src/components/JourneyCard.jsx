...
import list_icon from "../assets/tick-inside-circle.png";
import Button from './Button';
import journeyImage from "../assets/journey_img1.png"

const JourneyCard = ({ section, header, paragraph, list, image }) => {
    return (
        <section className={`journey_${section} relative mt-16`}>
            <div className="flex flex-col lg:flex-row justify-between max-w-screen-lg w-full mx-auto items-center px-4 lg:px-0">
                {/* Left Section */}
                    ...
                    <div className="px-0 lg:px-5">
                        ...
                        <ul className="list-none space-y-3">
                            <li className="flex items-center text-xs font-semibold">
                                <img src={list_icon} alt="list_item" width={15} /> &nbsp;
